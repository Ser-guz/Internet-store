...
class Product(models.Model):
    name = models.CharField(u"Имя", max_length=128, blank=True, null=True, default=None)
    category = models.ForeignKey(ProductCategory, on_delete=models.CASCADE, verbose_name='Категория',
                                 default=None, null=True, blank=True)
    price = models.DecimalField(u"Цена", max_digits=5, decimal_places=2, default=0)
    discount = models.IntegerField(u"Скидка", default=0)
    short_description = models.TextField(u"Описание (кратко)", max_length=100, blank=True, null=True, default=None)
    description = models.TextField(u"Описание", max_length=500, blank=True, null=True, default=None)
...
class ProductImage(models.Model):
    ...
    updated = models.DateTimeField(u"Обновлён", auto_now_add=False, auto_now=True)
    is_active = models.BooleanField(u"Видимость", default=True)
    is_main = models.BooleanField(u"На карточку", default=True)
